    ...
    <ul class="nav navbar-nav">
      <li class="nav-item">
        <a class="navbar-brand" href="{{url('/')}}">
          ...
          <h2 class="brand-text mb-0">Office</h2>
        </a>
      </li>
    </ul>
  </div>
    ...
    <div class="navbar-container d-flex content">
      ...
      <ul class="nav navbar-nav align-items-center ml-auto">
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" href="javascript:void(0);">
            <div class="user-nav bg-gradient-success px-2 py-50 rounded d-flex flex-row align-items-center">
              <div>
              ...
              <div>
                ...
                <p class="h5 font-monospace text-white text-left font-weight-bolder mb-0">
                  {{ $branch['code'] ?? '-'}}
                </p>
              </div>
            </div>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status capitalize">
                @php
                  $stringRole = '';
                  if (isset(Auth::user()->roles)) {
                    foreach (array_reverse(Auth::user()->roles) as $key => $value) {
                      if($key != 0) $stringRole .= ', ';
                      $stringRole .= str_replace("_", " ", $value);
                    }
                  } else {
                    $stringRole = '-';
                  }
            ...
            <span class="avatar">
              <img class="round" src="{{Auth::user()->profile_image ?? asset('images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="40"
                width="40">
              <span class="avatar-status-online"></span>
            </span>
          </a>
          <div class="dropdown-menu dropdown-menu-right" id="dropdown-user-menu">
