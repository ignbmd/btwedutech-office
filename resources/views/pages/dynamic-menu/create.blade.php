...
@section('title', 'Tambah Dynamic Survey Form')
...
<section id="input-sizing">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
                    <form action="{{ route('dynamic-menu.store') }}" id="dynamic_menu" method="POST">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="tags" class="select2 form-control hide-search" name="tags[]" multiple required>
                                </select>
                            </div>
