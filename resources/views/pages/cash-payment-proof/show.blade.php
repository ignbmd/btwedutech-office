...
<head>
  ...
  <title>{{ isset($ref_number) ? "Bukti Pembayaran Cash - $ref_number" : "Bukti Pembayaran Cash" }}</title>
  <style>
    @font-face {
  ...
  <table>
    ...
    <tr>
      <td class="vertical-align-top" width="60%">
        ...
        <div class="receipt-header-detail" style="margin-top: 20px">
      ...
      @if(!$is_preview)
        <td class="text-right" width="40%">
            {!! QrCode::size(100)->generate(url($downloadUrl)); !!}
        </td>
      @endif
    </tr>
