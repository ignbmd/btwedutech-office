...
@section('title', 'Bukti Pembayaran Cash')
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-inline-flex">
                      <a target="__blank" href="/bukti-pembayaran-cash/{{ $data->id }}/download" class="pr-1 hide-arrow text-white btn btn-sm btn-gradient-primary">
                        Download Kwitansi
                      </a>
                    </div>
                  </td>
    ...
    buttons: [
      {
        text:
          ...
          "Tambah Bukti Pembayaran Cash",
        className: "btn btn-primary",
        init: function (api, node, config) {
          $(node).removeClass("btn-secondary");
        },
        action: function (e, dt, button, config) {
          window.location = `${window.location.origin}/bukti-pembayaran-cash/tambah`;
        },
      },
    ],
    language: {
