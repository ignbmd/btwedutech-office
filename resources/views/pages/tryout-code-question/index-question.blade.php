...
@section('title', "Soal UKA Kode " . $tryoutCode->packages->title)
...
<script>
  window.addEventListener("load", function() {
    ...
    $(document).on('click', '.question-explanation', function() {
      ...
      const tryoutCodeID = @json($tryoutCode->id);
      ...
      const url = `${window.location.origin}/soal-uka-kode/${tryoutCodeID}/soal/${questionID}/pembahasan?qid=${encryptedText}`;
      window.open(url, '_blank');
    })
  });
</script>
