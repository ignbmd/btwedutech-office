...
<body>
    ...
    <table class="header">
        <tr>
            <td class="title">
                <h2>
                    RANKING SISWA {{$programTitle}} IRT
                </h2>
            </td>
    ...
    <div style="text-align: center">
        ...
        <h3 style="margin-top: 0;font-weight: normal">Tanggal {{dateFormat($ranks[0]->createdAt, 'd F Y')}}</h3>
    </div>
    <br>
        ...
        <table class="items custom-table" style="margin-top: 20px">
            ...
            <tr class="head">
                ...
                @foreach($score_keys as $key)
                    <th>{{ $questionCategories ? $questionCategories[$key] : str_replace("_", " ", $key) }}</th>
                @endforeach
                <th>Total Nilai</th>
            </tr>
