    ...
    <div class="card-body">
      <div class="row">
        <div class="col-12 col-md-6">
          <form id="form" action="{{ route('ranking.send-test-group-ranking') }}" method="POST">
            @csrf
...
<script>
  ...
  function submitForm(form) {
    ...
    if(submitType == "download") form.action = "/ranking/group-tryout-kode/dump";
    else form.action = "/ranking/group-tryout-kode/send-pdf/test";
    form.submit();
  }
