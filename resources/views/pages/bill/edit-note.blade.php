...
@section('title', 'Edit Catatan Tagihan')
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 col-md-6">
            <form id="submit-form" action="/tagihan/{{$billId}}/note" method="POST">
              @csrf
              @method("PUT")
              ...
              <div class="form-group">
                ...
                <textarea name="note" id="note" cols="30" rows="10" class="form-control" required>{!! $bill->note !!}</textarea>
