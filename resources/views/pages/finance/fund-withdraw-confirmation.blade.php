...
@section('title', 'Konfirmasi Penagihan Dana')
...
@section('content')
    ...
    <div id="fund-withdraw-confirmation-container"></div>
@endsection
...
@section('page-script')
    <script src="{{ asset(mix('js/scripts/finance/fund-withdraw-confirmation.js')) }}"></script>
@endsection
