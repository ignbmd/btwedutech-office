...
<form id="filterForm">
  <div class="card">
    ...
    <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
      <div class="col-md-3">
        <select id="branch_code" name="branch_code[]" class="form-control text-capitalize mb-md-0 mb-2 select2" required disabled multiple>
        </select>
      </div>
      <div class="col-md-3">
        <select id="classroom_id" name="classroom_id" class="form-control text-capitalize mb-md-0 mb-2 select2" required disabled>
...
<script src="{{ asset(mix('js/scripts/pages/class-progress/central/app.js')) }}"></script>
@endsection
