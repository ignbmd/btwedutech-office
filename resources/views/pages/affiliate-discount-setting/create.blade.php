...
@section('title', 'Tambah Atur Besaran Diskon Per Mitra')
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-12 col-md-6">
          <form action="{{ route('pengaturan-diskon-per-mitra.store') }}" method="POST">
            @csrf
            <div class="form-group">
              ...
              <select
                ...
                multiple
              >
                <option value="ALL">Pilih Semua Mitra</option>
