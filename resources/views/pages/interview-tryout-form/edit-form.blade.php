...
<section id="input-sizing">
  <form id="form" action="{{ route('update-hasil-wawancara', $interviewScore->_id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card">
      ...
      <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
        <div class="col-12">
          ...
          <input type="text" class="form-control" required name="class_member" value= "{{ $interviewScore->name }}" readonly>
        ...
        <div class="col-md-6 mt-2">
          ...
          <input id="ptk-school" type="text" class="form-control" disabled value= "{{ $studentTarget->school_name }}">
        </div>
        <div class="col-md-6 mt-2">
          <label>Program Studi</label>
          <input id="study-program" type="text" class="form-control" disabled value= "{{ $studentTarget->major_name }} ">
        </div>
        <div class="col-12 mt-2">
          <label>Sesi</label>
          <input type="text" class="form-control" required name="session_id" value="{{ $interviewScore->session_name }} - {{ $interviewScore->session_description }}" readonly />
        </div>
      </div>
    </div>
    <div class="row">
                        ...
                        <table id="datatables-basic" class="table">
                          ...
                          <tbody>
                            <tr>
                              <td class="radio-col" width="25%">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="penampilan" id="penampilan_1" value="4" required {{ $interviewScore->penampilan == "4" ? 'checked' : '' }}>
                            ...
                            <tr>
                              <td class="radio-col">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="penampilan" id="penampilan_2" value="3" required {{ $interviewScore->penampilan == "3" ? 'checked' : '' }}>
                            ...
                            <tr>
                              <td class="radio-col">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="penampilan" id="penampilan_3" value="2" required {{ $interviewScore->penampilan == "2" ? 'checked' : '' }}>
                            ...
                            <tr>
                              <td class="radio-col">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="penampilan" id="penampilan_4" value="1" required {{ $interviewScore->penampilan == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="cara_duduk_dan_berjabat" id="cara_duduk_dan_berjabat_1" value="4" required {{ $interviewScore->cara_duduk_dan_berjabat == "4" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="cara_duduk_dan_berjabat" id="cara_duduk_dan_berjabat_2" value="3" required {{ $interviewScore->cara_duduk_dan_berjabat == "3" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="cara_duduk_dan_berjabat" id="cara_duduk_dan_berjabat_3" value="2" required {{ $interviewScore->cara_duduk_dan_berjabat == "2" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="cara_duduk_dan_berjabat" id="cara_duduk_dan_berjabat_4" value="1" required {{ $interviewScore->cara_duduk_dan_berjabat == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100".>
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="praktek_baris_berbaris" id="praktek_baris_berbaris_1" value="4" required {{ $interviewScore->praktek_baris_berbaris == "4" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="praktek_baris_berbaris" id="praktek_baris_berbaris_2" value="3" required {{ $interviewScore->praktek_baris_berbaris == "3" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="praktek_baris_berbaris" id="praktek_baris_berbaris_3" value="2" required {{ $interviewScore->praktek_baris_berbaris == "2" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="praktek_baris_berbaris" id="praktek_baris_berbaris_4" value="1" required {{ $interviewScore->praktek_baris_berbaris == "1" ? 'checked' : '' }}>
                      ...
                      <div class="table-responsive w-100">
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="penampilan_sopan_santun" id="penampilan_sopan_santun_1" value="4" required {{ $interviewScore->penampilan_sopan_santun == "4" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="penampilan_sopan_santun" id="penampilan_sopan_santun_2" value="3" required required {{ $interviewScore->penampilan_sopan_santun == "3" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="penampilan_sopan_santun" id="penampilan_sopan_santun_3" value="2" required required {{ $interviewScore->penampilan_sopan_santun == "2" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="penampilan_sopan_santun" id="penampilan_sopan_santun_4" value="1" required required {{ $interviewScore->penampilan_sopan_santun == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kepercayaan_diri_dan_stabilitas_emosi" id="kepercayaan_diri_dan_stabilitas_emosi_1" value="4" required required {{ $interviewScore->kepercayaan_diri_dan_stabilitas_emosi == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kepercayaan_diri_dan_stabilitas_emosi" id="kepercayaan_diri_dan_stabilitas_emosi_2" value="3" required {{ $interviewScore->kepercayaan_diri_dan_stabilitas_emosi == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kepercayaan_diri_dan_stabilitas_emosi" id="kepercayaan_diri_dan_stabilitas_emosi_3" value="2" required {{ $interviewScore->kepercayaan_diri_dan_stabilitas_emosi == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kepercayaan_diri_dan_stabilitas_emosi" id="kepercayaan_diri_dan_stabilitas_emosi_4" value="1" required {{ $interviewScore->kepercayaan_diri_dan_stabilitas_emosi == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="komunikasi" id="komunikasi_1" value="4" required {{ $interviewScore->komunikasi == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="komunikasi" id="komunikasi_2" value="3" required {{ $interviewScore->komunikasi == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="komunikasi" id="komunikasi_3" value="2" required {{ $interviewScore->komunikasi == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="komunikasi" id="komunikasi_4" value="1" required {{ $interviewScore->komunikasi == "1" ? 'checked' : '' }}>
                    ...
                    {{-- Soal 7 --}}
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengembangan_diri" id="pengembangan_diri_1" value="4" required {{ $interviewScore->pengembangan_diri == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengembangan_diri" id="pengembangan_diri_2" value="3" required {{ $interviewScore->pengembangan_diri == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengembangan_diri" id="pengembangan_diri_3" value="2" required {{ $interviewScore->pengembangan_diri == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengembangan_diri" id="pengembangan_diri_4" value="1" required {{ $interviewScore->pengembangan_diri == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="integritas" id="integritas_1" value="4" required {{ $interviewScore->integritas == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check" width="25%">
                              <input class="form-check-input" type="radio" name="integritas" id="integritas_2" value="3" required {{ $interviewScore->integritas == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="integritas" id="integritas_3" value="2" required {{ $interviewScore->integritas == "2" ? 'checked' : '' }}>
                        ...
                        <td class="radio-col">
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="integritas" id="integritas_4" value="1" required {{ $interviewScore->integritas == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kerjasama" id="kerjasama_1" value="4" required {{ $interviewScore->kerjasama == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kerjasama" id="kerjasama_2" value="3" required {{ $interviewScore->kerjasama == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kerjasama" id="kerjasama_3" value="2" required {{ $interviewScore->kerjasama == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kerjasama" id="kerjasama_4" value="1" required {{ $interviewScore->kerjasama == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="mengelola_perubahan" id="mengelola_perubahan_1" value="4" required {{ $interviewScore->mengelola_perubahan == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="mengelola_perubahan" id="mengelola_perubahan_2" value="3" required {{ $interviewScore->mengelola_perubahan == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="mengelola_perubahan" id="mengelola_perubahan_3" value="2" required {{ $interviewScore->mengelola_perubahan == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="mengelola_perubahan" id="mengelola_perubahan_4" value="1" required {{ $interviewScore->mengelola_perubahan == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="perekat_bangsa" id="perekat_bangsa_1" value="4" required {{ $interviewScore->perekat_bangsa == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="perekat_bangsa" id="perekat_bangsa_2" value="3" required {{ $interviewScore->perekat_bangsa == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="perekat_bangsa" id="perekat_bangsa_3" value="2" required {{ $interviewScore->perekat_bangsa == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="perekat_bangsa" id="perekat_bangsa_4" value="1" required {{ $interviewScore->perekat_bangsa == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pelayanan_publik" id="pelayanan_publik_1" value="4" required {{ $interviewScore->pelayanan_publik == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pelayanan_publik" id="pelayanan_publik_2" value="3" required {{ $interviewScore->pelayanan_publik == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pelayanan_publik" id="pelayanan_publik_3" value="2" required {{ $interviewScore->pelayanan_publik == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pelayanan_publik" id="pelayanan_publik_4" value="1" required {{ $interviewScore->pelayanan_publik == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengambilan_keputusan" id="pengambilan_keputusan_1" value="4" required {{ $interviewScore->pengambilan_keputusan == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengambilan_keputusan" id="pengambilan_keputusan_2" value="3" required {{ $interviewScore->pengambilan_keputusan == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengambilan_keputusan" id="pengambilan_keputusan_3" value="2" required {{ $interviewScore->pengambilan_keputusan == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pengambilan_keputusan" id="pengambilan_keputusan_4" value="1" required {{ $interviewScore->pengambilan_keputusan == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="orientasi_hasil" id="orientasi_hasil_1" value="4" required {{ $interviewScore->orientasi_hasil == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="orientasi_hasil" id="orientasi_hasil_2" value="3" required {{ $interviewScore->orientasi_hasil == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="orientasi_hasil" id="orientasi_hasil_3" value="2" required {{ $interviewScore->orientasi_hasil == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="orientasi_hasil" id="orientasi_hasil_4" value="1" required {{ $interviewScore->orientasi_hasil == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="prestasi_akademik" id="prestasi_akademik_1" value="4" required {{ $interviewScore->prestasi_akademik == "4" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="prestasi_akademik" id="prestasi_akademik_2" value="3" required {{ $interviewScore->prestasi_akademik == "3" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="prestasi_akademik" id="prestasi_akademik_3" value="2" required {{ $interviewScore->prestasi_akademik == "2" ? 'checked' : '' }}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="prestasi_akademik" id="prestasi_akademik_4" value="1" required {{ $interviewScore->prestasi_akademik == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="prestasi_non_akademik" id="prestasi_non_akademik_1" value="4" required {{ $interviewScore->prestasi_non_akademik == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="prestasi_non_akademik" id="prestasi_non_akademik_2" value="3" required {{ $interviewScore->prestasi_non_akademik == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="prestasi_non_akademik" id="prestasi_non_akademik_3" value="2" required {{ $interviewScore->prestasi_non_akademik == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="prestasi_non_akademik" id="prestasi_non_akademik_4" value="1" required {{ $interviewScore->prestasi_non_akademik == "1" ? 'checked' : '' }}>
                    ...
                    <div class="table-responsive w-100">
                      ...
                      <tbody>
                        <tr>
                          <td class="radio-col" width="25%">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="bahasa_asing" id="bahasa_asing_1" value="4" required {{ $interviewScore->bahasa_asing == "4" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="bahasa_asing" id="bahasa_asing_2" value="3" required {{ $interviewScore->bahasa_asing == "3" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="bahasa_asing" id="bahasa_asing_3" value="2" required {{ $interviewScore->bahasa_asing == "2" ? 'checked' : '' }}>
                        ...
                        <tr>
                          <td class="radio-col">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="bahasa_asing" id="bahasa_asing_4" value="1" required {{ $interviewScore->bahasa_asing == "1" ? 'checked' : '' }}>
                      ...
                      {{-- <div class="card-text">
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="bersedia_pindah_jurusan" id="bersedia_pindah_jurusan_1" value="true" required {{ $interviewScore->bersedia_pindah_jurusan == true ? 'checked' : ''}}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="bersedia_pindah_jurusan" id="bersedia_pindah_jurusan_2" value="false" required {{ $interviewScore->bersedia_pindah_jurusan  == false ? 'checked' : ''}}>
                      ...
                      <h4 class="mt-2">Penutup</h4>
                        ...
                        <tbody>
                          <tr>
                            <td class="radio-col" width="25%">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="closing_statement" id="closing_statement_1" value="true" required {{ $interviewScore->closing_statement  == true ? 'checked' : ''}}>
                          ...
                          <tr>
                            <td class="radio-col">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="closing_statement" id="closing_statement_2" value="false" required {{ $interviewScore->closing_statement  == false ? 'checked' : ''}>
                  ...
                  {{-- <div class="card"> --}}
                    <div class="table-responsive w-100 p-1">
                      ...
                      <tbody>
                        ...
                        <textarea name="note" id="note" class="form-control w-100" placeholder="Masukan Catatan ....">{{ $interviewScore->note ?? '' }}</textarea>
                      </tbody>
                      </table>
                    </div>
                  {{-- </div> --}}
                  <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary">Simpan Hasil Wawancara</button>
                  </div>
                </div>
            </div>
        </div>
