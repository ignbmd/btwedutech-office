        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-md-8">
                    <form action="{{ route('top-up-coins.store') }}" id="" method="POST">
                        @csrf
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="smartbtw_id" required name="smartbtw_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="coins" required min="1" max="10000" name="coins" 
                                placeholder="yang anda masukan adalah nominal asli">
