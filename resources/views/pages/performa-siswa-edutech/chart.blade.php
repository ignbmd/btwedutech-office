...
@section('title', "Grafik Performa Siswa BTW Edutech")
...
@section('page-script')
  ...
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/utils/utils.js') }}"></script>
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/config/twk-chart.js') }}"></script>
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/config/tiu-chart.js') }}"></script>
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/config/tkp-chart.js') }}"></script>
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/config/skd-chart.js') }}"></script>
  <script src="{{ mix('js/scripts/pages/edutech-module-summary-chart/app.js') }}"></script>
@endsection
