...
<head>
    ...
    @elseif ($branchTitle)
        <title>{{ 'Laporan Rekapitulasi Perkembangan Siswa Kelas SmartBTW - ' . $branchTitle }}</title>
    @endif
    ...
    <div class="content">
        ...
        <table class="items custom-table" style="margin-top: 20px">
            <tr class="head">
                ...
                @if ($branchTitle)
                    <th rowspan="2" width="15%">Cabang</th>
                @endif
                {{-- <th rowspan="2" width="15%">Email</th> --}}
                <th rowspan="2" width="7%">Modul Diterima</th>
                <th rowspan="2" width="7%">Modul Dikerjakan</th>
                <th rowspan="2" width="8%">Persentase Kepatuhan</th>

                @if($program !== "tps")
                  <th rowspan="2" width="8%">Persentase Kelulusan</th>
                  <th colspan="4" width="17%">Nilai Rata-rata</th>
                @else
                  <th colspan="5" width="17%">Nilai Rata-rata</th>
                @endif

                <th rowspan="2" width="7%">Rata-rata Mengerjakan</th>
                <th rowspan="2" width="7%">Total Mengerjakan</th>
            </tr>
            <tr class="head">
            ...
            <tbody>
                ...
                @foreach ($payload['results'] as $result)
                    <tr class="row" style="text-align: center">
                        ...
                        @if ($branchTitle)
                            <td class="{{ isset($orderBy) && $orderBy == "email" ? 'bg-highlight' : '' }}">
                                {{ $branchNames[$studentBranches[$result->student->smartbtw_id]] }}</td>
                        @endif
