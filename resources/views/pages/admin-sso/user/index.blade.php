        ...
        <div class="card-header border-bottom p-1">
          ...
          <div class="text-right">
            <div class="d-inline-flex">
              <a href="/admin-sso/users/tambah" class="btn btn-primary">
                ...
                <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item w-100" href="/admin-sso/users/edit/{{ $data->id }}">
  ...
  $(function() {
    ...
    function showConfirmationPopUp(id) {
      Swal.fire({
       ...
       function deleteUser(ssoId) {
        const token = $("meta[name='csrf-token']").attr("content");

         $.ajax({
           url: `/api/sso/user/${ssoId}`,
           type: "DELETE",
           data : { "_token": token },
    ...
    function showDeleteSuccessToast(data) {
      toastr.success(data?.data.message, "Hapus user berhasil", {
        timeOut: 1500,
        closeButton: true,
        tapToDismiss: true,
        preventDuplicates: true,
        onHidden() {
          window.location.href = "/admin-sso/users";
        },
      })
    }
    function showDeleteErrorToast() {
      toastr.error("Proses hapus user gagal, silakan coba lagi nanti", "Terjadi kesalahan", {
        timeOut: 2000,
        closeButton: true,
        tapToDismiss: true,
        preventDuplicates: true,
