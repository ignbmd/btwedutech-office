        ...
        <div class="card-header border-bottom p-1">
          ...
          <div class="text-right">
            <div class="d-inline-flex">
              <form action="/stages/{{$type}}/lock-status" method="POST">
                @csrf
                @method("PUT")
              ...
              @if(!$isStagesLocked)
                <a href="/stages/{{$type}}/create" class="btn btn-primary">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
          ...
          <table class="datatables-basic table">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if(!$isStagesLocked)
                  <td>
                    <a href="/stages/{{ $data->type }}/{{ $data->_id }}/edit" class="btn btn-warning btn-sm">Edit</a>
                  </td>
                @endif
              </tr>
              @empty
