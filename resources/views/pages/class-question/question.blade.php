...
@if($program === "skd")
  @section('title', "Soal Kelas $testTypeTitle - $upperCasedQuestionCategory ($subCategoryModule->title)")
@else
  @section('title', "Soal Kelas $testTypeTitle - " . ucwords(str_replace('-', ' ', $question_category)))
@endif
...
<script>
  window.addEventListener("load", function() {
    ...
    $(document).on('click', '.question-explanation', function() {
      ...
      const url = `${window.location.origin}/soal-kelas/${testType}/${program}/${questionCategory}/${moduleCode}/${questionID}/pembahasan?qid=${encryptedQuestionIdText}&mid=${encryptedUserIdText}&mnm=${encryptedUserNameText}`;
