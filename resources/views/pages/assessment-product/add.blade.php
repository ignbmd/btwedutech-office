...
@section('title', 'Tambah Produk Assessment')
...
<section id="input-sizing">
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-lg-6">
          <form id="addPackageForm" method="POST" action="/produk-assessment/tambah" enctype="multipart/form-data">
            @csrf
            @include('pages.assessment-product._base-add-form')
...
<script src="{{ asset(mix('js/scripts/pages/assessment-product/add-product.js')) }}"></script>
@endsection
