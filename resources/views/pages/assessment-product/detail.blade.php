            ...
            <div class="card-body">
                <div class="row my-2">
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <small>
                            @if ($product->type == 'ASSESSMENT_PRODUCT')
                                Produk Assessment
                            @elseif($product->type == 'ASSESSMENT_PSYCHOLOG_PRODUCT')
                                Produk Assessment Psikolog
                            @elseif($product->type == 'BUNDLE_PSYCHOLOG_PRODUCT')
                                Produk Bundle Psikolog
                            @endif
                        ...
                        <div class="d-flex flex-column flex-sm-row pt-4">
                            <a href="/produk-assessment/edit/{{ $product->_id }}" class="btn btn-primary mr-0 mr-sm-1 mb-1 mb-sm-0">
