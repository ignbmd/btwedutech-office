...
@section('title', 'Edit Produk Assessment')
...
<section id="input-sizing">
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-lg-6">
          <form id="editPackageForm" action="/produk-assessment/perbarui" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @include('pages.assessment-product._base-edit-form')
...
<script src="{{ asset(mix('js/scripts/pages/assessment-product/edit-product.js')) }}"></script>
@endsection
