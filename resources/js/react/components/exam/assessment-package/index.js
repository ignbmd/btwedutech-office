...
import { columns, getPackages } from "../../../data/assessment-pacakge-table";
    ...
    <Card>
      <Row className="justify-content-end mx-0">
        <Col
          ...
          sm="12"
        >
          <a href="/ujian/paket-assessment/create" className="btn btn-primary">
            <Plus size={14} /> Tambah Modul Paket Assessment
          </a>
        </Col>
      </Row>
      <hr />
