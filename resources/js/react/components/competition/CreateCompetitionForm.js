...
const FormSchema = yup.object().shape({
  ...
  region_id: yup.object().when("province_id", {
    ...
    then: (schema) => schema.typeError("Wajib dipilih").required("Wajib dipilih"),
...
const CreateCompetitionForm = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      await axios.post("/api/competition-map/competition", {
        ...payload,
              ...
              <Col md={6} className={classnames("pl-0")}>
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => {
                    ...
                    return (
                      <FormGroup className="flex-fill">
                        <Label className="form-label">Posisi Terendah</Label>
                        <Cleave
                          {...field}
                          options={normalNumber}
                          className={classnames("form-control", {
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => {
                    ...
                    return (
                      <FormGroup className="flex-fill">
                        <Label className="form-label">Status Terendah</Label>
                        <Select
                          {...field}
                          styles={{
                            menu: (provided) => ({
