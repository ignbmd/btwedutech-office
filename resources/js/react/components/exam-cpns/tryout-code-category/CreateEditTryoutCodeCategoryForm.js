...
const CreateEditTryoutCodeForm = ({ type }) => {
  ...
  const getCurrentTryoutCodeCategory = async () => {
    try {
      ...
      const response = await axios.get(
        `/exam-cpns/tryout-code-category/detail/${id}`,
        {
  ...
  const redirectToIndex = () => {
    window.location.href = "/ujian-cpns/kategori-tryout-kode";
  };
  ...
  const processFormCreate = async () => {
    ...
    try {
      const response = await axios.post(
        "/exam-cpns/tryout-code-category/create",
        payload
      );
  ...
  const processFormUpdate = async () => {
    ...
    try {
      const response = await axios.put(
        "/exam-cpns/tryout-code-category/update",
        payload
      );
      if (!isCanceled.current) {
        redirectToIndex();
