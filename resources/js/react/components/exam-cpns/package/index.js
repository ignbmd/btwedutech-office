...
import { columns, getPackages } from "../../../data/exam-cpns/package-table";

import TableLoader from "../../core/skeleton-loader/TableLoader";

const PacakgeTableContext = createContext();

const CustomPagination = () => {
  const { data, filteredData, searchValue, currentPage, handlePagination } =
    useContext(PacakgeTableContext);
  return (
    <ReactPaginate
      previousLabel=""
      nextLabel=""
...
const PackageTable = () => {
  ...
  return (
    <PacakgeTableContext.Provider value={contextProviderValue}>
      <Card>
        <Row className="justify-content-end mx-0">
          <Col
            ...
            sm="12"
          >
            <a href="/ujian-cpns/paket-soal/create" className="btn btn-primary">
              <Plus size={14} /> Tambah Modul Paket Soal
            </a>
          </Col>
        </Row>
        <hr />
