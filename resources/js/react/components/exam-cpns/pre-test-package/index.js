...
import {
  columns,
  getPreTestPackages,
} from "../../../data/exam-cpns/pre-test-package-table";

import TableLoader from "../../core/skeleton-loader/TableLoader";

const PreTestPackageTable = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await getPreTestPackages();
    ...
    <Card>
      <Row className="justify-content-end mx-0">
        <Col
          ...
          sm="12"
        >
          <a href="/ujian-cpns/paket-pre-test/create" className="btn btn-primary">
            <Plus size={14} /> Tambah Paket Pre-Test
          </a>
        </Col>
      </Row>
      <hr />
...
export default PreTestPackageTable;
