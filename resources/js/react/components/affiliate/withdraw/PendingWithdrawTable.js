...
import { columns } from "../../../data/pending-withdraw-table";
import TableLoader from "../../core/skeleton-loader/TableLoader";

const PendingWithdrawTableContext = createContext();

const CustomPagination = () => {
  const { currentPage, handlePagination, searchValue, filteredData, data } =
    useContext(PendingWithdrawTableContext);
  return (
    <ReactPaginate
      previousLabel=""
      nextLabel=""
...
const PendingWithdrawTable = ({ data }) => {
  ...
  return (
    <PendingWithdrawTableContext.Provider value={contextProviderValue}>
      <Card>
    ...
    </PendingWithdrawTableContext.Provider>
  );
};
