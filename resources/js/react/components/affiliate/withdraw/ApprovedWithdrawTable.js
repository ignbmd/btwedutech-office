...
import { columns } from "../../../data/approved-withdraw-table";
import TableLoader from "../../core/skeleton-loader/TableLoader";

const ApprovedWithdrawTableContext = createContext();

const CustomPagination = () => {
  const { currentPage, handlePagination, searchValue, filteredData, data } =
    useContext(ApprovedWithdrawTableContext);
  return (
    <ReactPaginate
      previousLabel=""
      nextLabel=""
...
const ApprovedWithdrawTable = ({ data }) => {
  ...
  return (
    <ApprovedWithdrawTableContext.Provider value={contextProviderValue}>
      <Card>
    ...
    </ApprovedWithdrawTableContext.Provider>
  );
};

export default ApprovedWithdrawTable;
