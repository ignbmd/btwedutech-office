...
import { columns, getLastEducation } from "../../data/last-education-table";
import { useEffect } from "react";
import ContentLoader from "react-content-loader";

const LastEducationTable = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await getLastEducation();
    ...
    <Card>
      <Row className="justify-content-end mx-0">
        <Col
          ...
          sm="12"
        >
          <a href="/peta-persaingan/pendidikan-terakhir/tambah" className="btn btn-primary">
            <Plus size={14} /> Tambah Pendidikan Terakhir
          </a>
        </Col>
      </Row>
      <hr />
...
export default LastEducationTable;
