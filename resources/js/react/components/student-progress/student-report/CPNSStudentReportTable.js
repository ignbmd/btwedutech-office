...
const CPNSStudentReportTable = () => {
  ...
  const averageTkpScore = () => {
    let average = 0;
    let total = 0;
    for (let data of studentResult?.histories ?? []) {
      total += data.category.tkp.score;
    }
    average = studentResult?.histories?.length
      ? total / studentResult?.histories?.length
      : "-";
  ...
  const footerGroup = (
    <ColumnGroup>
      <Row>
        ...
        />
        <Column footer={averageTwkScore} />
        <Column footer={averageTiuScore} />
        <Column footer={averageTkpScore} />
  ...
  const passStatusTemplate = (report) => {
    return report.status ? "Lulus" : "Tidak Lulus";
  };
      ...
      <CardBody>
        <PrimeReactProvider>
          ...
          >
            ...
            ></Column>
            <Column field="exam_name" header="Modul" sortable></Column>
            <Column
            ...
            ></Column>
            <Column
              field="category.twk.score"
              header="Nilai TWK"
              sortable
            ></Column>
            <Column
              field="category.tiu.score"
              header="Nilai TIU"
              sortable
            ></Column>
            <Column
              field="category.tkp.score"
              header="Nilai TKP"
              sortable
            ></Column>
            <Column field="total" header="Nilai Total" sortable></Column>
            <Column body={passStatusTemplate} header="Status" sortable></Column>
            <Column
...
export default CPNSStudentReportTable;
