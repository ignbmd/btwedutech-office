...
const PTNClassroomReportTable = () => {
  ...
  const targetTemplate = (data) => {
    return `${data?.student_target_ptn?.school_name} - ${data?.student_target_ptn?.major_name}`;
  };

  const passPercentageTemplate = (data) => {
    return `${data?.student_target_ptn?.current_target_percent_score}%`;
  };
      ...
      <CardBody>
        <PrimeReactProvider>
          <DataTable
            ...
            globalFilterFields={[
              "name",
              "student_target_ptn.school_name",
              "student_target_ptn.major_name",
              "student_target_ptn.target_score",
              "summary.owned",
              "summary.done",
              "summary.score_values.PU.average_score",
              "summary.score_values.PPU.average_score",
              "summary.score_values.PBM.average_score",
              "summary.score_values.PK.average_score",
              "summary.score_values.LBIND.average_score",
              "summary.score_values.LBING.average_score",
              "summary.score_values.PM.average_score",
              "summary.average_score",
              "student_target_ptn.current_target_percent_score",
            ]}
          >
            <Column
            ...
            ></Column>
            <Column
              field="student_target_ptn.target_score"
            ...
            ></Column>
            <Column
              field="summary.score_values.PU.average_score"
              header="Nilai rata-rata PU"
              sortable
            ></Column>
            <Column
              field="summary.score_values.PPU.average_score"
              header="Nilai rata-rata PPU"
              sortable
            ></Column>
            <Column
              field="summary.score_values.PBM.average_score"
              header="Nilai rata-rata PBM"
              sortable
            ></Column>
            <Column
              field="summary.score_values.PK.average_score"
              header="Nilai rata-rata PK"
              sortable
            ></Column>
            <Column
              field="summary.score_values.LBIND.average_score"
              header="Nilai rata-rata LBIND"
              sortable
            ></Column>
            <Column
              field="summary.score_values.LBING.average_score"
              header="Nilai rata-rata LBING"
              sortable
            ></Column>
            <Column
              field="summary.score_values.PM.average_score"
              header="Nilai rata-rata PM"
              sortable
            ></Column>
            <Column
              field="summary.average_score"
              header="Nilai rata-rata UTBK"
              sortable
            ></Column>
            <Column
...
export default PTNClassroomReportTable;
