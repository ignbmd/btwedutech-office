...
import { columns, getLocation } from "../../data/location-region-table";
import { useEffect } from "react";
import ContentLoader from "react-content-loader";

const DetailLocationTable = () => {
    ...
    <Card>
      <Row className="justify-content-end mx-0">
        <Col
          ...
          sm="12"
        >
          <a href="/peta-persaingan/lokasi/tambah" className="btn btn-primary">
...
export default DetailLocationTable;
