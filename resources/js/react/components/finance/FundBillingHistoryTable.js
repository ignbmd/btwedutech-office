  ...
  const handleFilter = (e) => {
    ...
    setFilteredData(
      histories.filter((item) => {
        ...
        //   ? item?.contact?.bank_account_type.toLowerCase().includes(key)
        //   : true;
        // const matchByAccountNumber = item?.contact?.bank_account_number
        //   ? item?.contact?.bank_account_number
        //       .toString()
        //       .toLowerCase()
        //       .includes(key)
        //   : true;
        const matchByBranchName = item?.branch_name.toLowerCase().includes(key);
        const anyMatch = [
          matchByAmount,
...
export default FundBillingHistoryTable;
