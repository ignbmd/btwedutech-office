...
const EditFundWithdrawForm = () => {
  ...
  const submitHandler = async (data) => {
    ...
    try {
      const response = await axios.put(`/api/finance/transfer-fund/${id}`, {
        ...payload,
  ...
  useEffect(() => {
    ...
    setValue("withdraw_amount", fund?.amount);
  }, [contact]);
...
export default EditFundWithdrawForm;
