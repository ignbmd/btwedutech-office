...
export const fetchQuestions = async ({ program, types, limit = 50, pages = 1, search = "", config, question_category_id = "" }) => {
  try {
    const response = await axios.get(
...
export const fetchQuestionsBySearchId = async ({ program, types, limit = 50, pages = 1, search_id = "", config, question_category_id = "" }) => {
  try {
    const response = await axios.get(
