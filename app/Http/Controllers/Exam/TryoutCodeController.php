...
class TryoutCodeController extends Controller
{
    ...
    public function __construct(TryoutCode $tryoutCode) {
      ...
      Breadcrumb::setFirstBreadcrumb('Tryout Kode', 'ujian/tryout-kode');
    }
    ...
    public function index() {
      ...
      return view('/pages/exam/tryout-code/index', compact('breadcrumbs', 'isMarketingUser', 'isBranchUser', 'userBranchCode', 'liveRankingHost'));
    }

    public function showCreateForm() {
      $breadcrumbs = [Breadcrumb::getFirstPageBreadcrumb(true), ['name' => 'Buat Tryout Kode']];
      $isMarketingUser = UserRole::isMarketing();
      $isBranchUser = UserRole::isBranchUser();
      $userBranchCode = Auth::user()->branch_code;
      return view('/pages/exam/tryout-code/create', compact('breadcrumbs', 'isMarketingUser', 'isBranchUser', 'userBranchCode'));
    }
    ...
    public function edit($id) {
      ...
      $breadcrumbs = [Breadcrumb::getFirstPageBreadcrumb(true), ['name' => 'Edit Tryout Kode']];
      return view('/pages/exam/tryout-code/edit', compact('breadcrumbs', 'isMarketingUser', 'isBranchUser', 'userBranchCode'));
    }
}
