...
class SendStudentTryoutReportToRabbitMqTest extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'report:rabbitmq-test {program} {exam_type?}';
    ...
    foreach ($classrooms as $classroom) {
      ...
      if (!empty($class_members)) {
        ...
        foreach ($members as $member) {
          ...
          $phone_numbers = ["082237808008", "085737573551", "087862216989"];
