...
class SendStudentReportChartTest extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'student-chart-test:send {classroom_id} {exam_type}';
     ...
     * @var string
     */
    protected $description = 'Test Send Student Module Summary Data to RabbitMQ Message Broker';
    ...
    {
      $classroom_id = $this->argument('classroom_id');
      $class_members = $this->learningClassMemberService->getByClassroomId($classroom_id);
      $tryoutTitle = "";
        ...
        foreach($members as $member) {
          ...
          if($studentResult && $studentHasReportProperty) {
            ...
            if($isPackageExamType)  {
              ...
              if(property_exists($package, 'title')) $tryoutTitle = $package->title;
              else {
            ...
            $studentResult->parent_number = "6287862216989";
